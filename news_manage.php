...
try {
    ...
    // Total Count
    $countStmt = $pdo->prepare("SELECT COUNT(*) FROM news WHERE $where");
        ...
        <main class="flex-1 overflow-y-auto bg-slate-50">
            ...
            <div class="p-8 max-w-7xl mx-auto">
                ...
                <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <form action="" method="GET" class="flex-1 w-full sm:w-auto relative">
                        <input type="text" name="q" placeholder="Search by title..." value="<?php echo htmlspecialchars($search); ?>" class="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-sm focus:outline-none focus:border-cool_sky-500 font-medium">
                    ...
                    <div class="flex gap-2">
                        <!-- Add Status Filter later if needed -->
                    </div>
                </div>
                                    ...
                                    <tr class="hover:bg-slate-50/80 transition-colors group">
                                        <td class="px-8 py-5">
                                            <div class="flex items-center gap-4">
                                                <img src="<?php echo htmlspecialchars($img); ?>" class="w-12 h-12 rounded-xl object-cover border border-slate-100">
                                                <div class="max-w-xs">
                                        ...
                                        <td class="px-6 py-5">
                                            ...
                                            <?php else: ?>
                                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-jasmine-50 text-jasmine-600 border border-jasmine-100">
                                                    <span class="w-1.5 h-1.5 rounded-full bg-jasmine-500"></span> Draft
                                                </span>
                                            <?php endif; ?>
                                        </td>
